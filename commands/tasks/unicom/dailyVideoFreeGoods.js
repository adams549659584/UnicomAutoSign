  ...
  doTask: async (axios, options) => {
    ...
    for (let good of goods) {
      ...
      result = await axios.request({
        ...
        headers: {
          "user-agent": useragent,
          "referer": `https://wxapp.msmds.cn/h5/react_web/unicom/freeTakeGoodDetail/${good.id}?source=unicom&type=02&ticket=${searchParams.ticket}&version=android@8.0200&timestamp=${timestamp}&desmobile=${options.user}&num=0&postage=${searchParams.postage}&userNumber=${options.user}        `,
          "origin": "https://wxapp.msmds.cn"
        },
